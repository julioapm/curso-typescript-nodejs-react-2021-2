...
const uri = 'mongodb+srv://dbUser:ZbXSO3nEaWd3aE86@cluster0.szsx0.mongodb.net/myFirstDatabase?retryWrites=true&w=majority'
...
async function main() {
    try {
        ...
        /*
        const pessoa: Pessoa = { nome: 'João', idade: 20 };
        ...
        */
        ...
        const resultadoAlteracao = await colecao.updateOne({ _id: new ObjectId('617357449508d9af52a4e38d') }, { $set: { idade: 18 } });
        ...
        const resultadoExclusao = await colecao.deleteOne({ _id: new ObjectId('61738e0d00b4c8ad07006700') });
